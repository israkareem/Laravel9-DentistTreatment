...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <a href="{{route('admin.category.create')}}" class="btn btn-outline-primary btn-lg"  style="width: 200px"> Add Category</a>
            <h3 style="margin-left:30px;margin-bottom:30px;margin-top: 20px">Category List</h3>
            <div class="section__content section__content--p30">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>{{$rs->status}}</td>
                                    <td>
                                        <a href="{{route('admin.category.show',['id'=>$rs->id])}}" type="button" class="btn btn-primary">Show</a>
                                        <a href="{{route('admin.category.edit',['id'=>$rs->id])}}" type="button" class="btn btn-success">Edit</a>
                                        <a href="{{route('admin.category.delete',['id'=>$rs->id])}}" type="button" class="btn btn-danger"
