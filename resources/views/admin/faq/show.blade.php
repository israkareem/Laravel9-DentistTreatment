                    ...
                    <div   class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{route('admin.treatment.update',['id'=>$data->id])}}" method="post">
                                ...
                                <a href="{{route('admin.treatment.edit',['id'=>$data->id])}}" type="button" class="btn btn-success">Edit</a>
                                <a href="{{route('admin.treatment.delete',['id'=>$data->id])}}" type="button" class="btn btn-danger"
