...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <a href="{{route('admin.faq.create')}}" class="btn btn-outline-primary btn-lg"  style="width: 200px"> Add Question</a>
            <h3 style="margin-left:30px;margin-bottom:30px;margin-top: 20px">Faq List</h3>
            <div class="section__content section__content--p30">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.faq.show',['id'=>$rs->id])}}" type="button" class="btn btn-primary">Show</a>
                                        <a href="{{route('admin.faq.edit',['id'=>$rs->id])}}" type="button" class="btn btn-success">Edit</a>
                                        <a href="{{route('admin.faq.delete',['id'=>$rs->id])}}" type="button" class="btn btn-danger"
