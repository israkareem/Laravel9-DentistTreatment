...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <a href="{{route('admin.treatment.create')}}" class="btn btn-outline-primary btn-lg"  style="width: 200px"> Add Treatment</a>
            <h3 style="margin-left:30px;margin-bottom:30px;margin-top: 20px">Treatment List</h3>
            <div class="section__content section__content--p30">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        onclick="return !window.open(this.href,'','top=50 left=100 height=1000, width=700')">
                                        <img src="{{asset('assets')}}/admin/images/gallery.jpg" style="height: 20px"  />
                                        </a>
                                    </td>
                                    <td>{{$rs->title}}</td>
